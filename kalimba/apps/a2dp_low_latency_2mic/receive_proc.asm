...
// Data object used with $stream_copy.pass_thru function
   ...
   // The DAC peak level monitoring has been moved to the output handler
   // However, the original process structures have been kept
   // and are reused by the cbops peak level operators.
   ...
   .VAR/DM1 mute_cntrl_r_dm1[$M.MUTE_CONTROL.STRUC_SIZE] =
    ...
    .VAR/DM2 MeloD_Expansion_struct[$MeloD_Expansion.STRUC_SIZE] =
        ...
        &stream_map_left_out,
        &stream_map_right_out,
        &$M.CVC.data.CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_CONFIG,   // PTR TO CONFIG WORD WHICH CONTAINS BYPASS BIT
