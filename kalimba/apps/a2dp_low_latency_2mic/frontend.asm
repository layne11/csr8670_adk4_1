// *****************************************************************************
// Copyright (c) 2003 - 2016 Qualcomm Technologies International, Ltd.         http://www.csr.com
// Part of ADK 4.1
//
// $Change:  $  $DateTime:  $
// *****************************************************************************
// *****************************************************************************
// Frontend for a2dp_low_latency_2mic
//
// Configuration :
//      ADC         @ 16kHz
//      DAC/I2S out @ 44.1 or 48kHz
//      Timer Task  @ 1500 uSec
//
// Interface points :
...
.CONST  $ADCDAC_PERIOD_USEC           0.0015;
...
.CONST  $OUTPUT_AUDIO_CBUFFER_SIZE     ((15*TMR_PERIOD_AUDIO_COPY * 48)/1000);  
...
.MODULE $M.adc_in;
   ...
   DeclareCBuffer(sidetone_cbuffer_struc,sidetone_mem,(4*48));
    ...
    .BLOCK sync_op;
      ...
      .VAR sync_op.next_op = &left_shift_op;
    ...
    .BLOCK left_shift_op;
      .VAR left_shift_op.prev_op = &sync_op;
      .VAR left_shift_op.next_op = &right_shift_op;
    ...
    .BLOCK right_shift_op;
      .VAR right_shift_op.prev_op = &left_shift_op;
      .VAR right_shift_op.next_op = &sidetone_copy_op;
      .VAR right_shift_op.func = &$cbops.shift;
      .VAR right_shift_op.param[$cbops.shift.STRUC_SIZE] =
           ADCINDEX_PORT_RIGHT,    // Input index (left input port)
           ADCINDEX_CBUFFER_RIGHT, // Output index (left cbuffer)
           8;                      // Shift amount
    .ENDBLOCK;

    .BLOCK sidetone_copy_op;
      .VAR sidetone_copy_op.prev_op = &right_shift_op;
      ...
      .VAR sidetone_copy_op.param[CBOPS_SIDETONE_FILTER_OBJECT_SIZE(SIDETONE_PEQ_STAGES)] =
           ...
           $M.A2DP_LOW_LATENCY_2MIC.CONFIG.SIDETONEENA,  // SideTone Enable Mask
           &$M.CVC.data.CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_ST_CLIP_POINT,  // Pointer to Sidetone Parameters
           0,                        // Apply Filter-Filter
           0.0,                      // APPLY_GAIN
           0,                        // NOISE_LEVEL_PTR_FIELD
           0,                        // Config
           ...
           &$M.CVC.data.CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_ST_PEQ_CONFIG,  // Pointer to PEQ parameters
           0 ...;
    .ENDBLOCK;
   ...
   .VAR copy_struc[] =
    ...
    .BLOCK auxillary_mix_right_op;
      ...
      .VAR auxillary_mix_right_op.param[$cbops.aux_audio_mix_op.STRUC_SIZE] =
           ...
           0,                               // Hold Timer
           -128,                            // Hold count. ~96 msec (96/0.750ms) = 128
