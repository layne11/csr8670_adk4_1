...
.ENDBLOCK;
   ...
   .VAR/ADDR_TABLE_DM   ParameterMap[] =
      ...
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_S_EQ_B1,  &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_S_EQ_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_S_EQ_B0,  &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_S_EQ_B0,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_S_EQ_A1,  &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_S_EQ_A1,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP1_B2, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP1_B2,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP1_B1, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP1_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP1_B0, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP1_B0,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP2_B2, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP2_B2,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP2_B1, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP2_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP2_B0, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP2_B0,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP1_B2, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP1_B2,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP1_B1, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP1_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP1_B0, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP1_B0,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP2_B2, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP2_B2,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP2_B1, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP2_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_2MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP2_B0, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP2_B0,
#endif
   ...
   .VAR/ADDR_TABLE_DM  StatisticsPtrs[] = //[$M.A2DP_LOW_LATENCY_2MIC.STATUS.BLOCK_SIZE+2] =
     ...
     &$M.system_config.data.dac_r_pk_dtct + $M.audio_proc.peak_monitor.PEAK_LEVEL,   // FOR PEAK_DACR_OFFSET
      ...
      &$M.set_codec_rate.current_codec_sampling_rate,   // CODEC_FS_OFFSET
      &TwoValue,                                        // CODEC_CHANNEL_MODE
#ifdef APTX_ACL_SPRINT_ENABLE
      &$M.aptx_sprint.security_status.stat,             // CODEC_STAT1
      &$aptx_decoder_version,                           // CODEC_STAT2
#else
      ...
      &$M.set_dac_rate.audio_if_mode,                   // INTERFACE_TYPE
...
#if uses_STEREO_ENHANCEMENT
    $MeloD_Expansion.initialize,        &$M.system_config.data.MeloD_Expansion_struct,    0,
#endif

#if uses_SPKR_EQ
    $user_eq.eqInitialize,              &$M.system_config.data.SpkrEqDefnTable,     &$M.system_config.data.SpkrEqParams,
#endif
#if uses_BASS_BOOST
    $user_eq.eqInitialize,              &$M.system_config.data.BoostEqDefnTable,    &$M.system_config.data.BoostEqParams,
#endif
#if uses_USER_EQ
    $user_eq.userEqInitialize,          &$M.system_config.data.UserEqDefnTable,     &$M.system_config.data.user_eq_bank_select,
#endif
...
#if uses_DCBLOCK
    $audio_proc.peq.zero_delay_data,         &in_l_dcblock_dm2,                         0,
    $audio_proc.peq.zero_delay_data,         &in_r_dcblock_dm2,                         0,
#endif
...
#if uses_SPKR_EQ
    $audio_proc.hq_peq.zero_delay_data,      &$M.system_config.data.spkr_eq_left_dm2,   0,
    $audio_proc.hq_peq.zero_delay_data,      &$M.system_config.data.spkr_eq_right_dm2,  0,
#endif

#if uses_BASS_BOOST
    $audio_proc.hq_peq.zero_delay_data,      &$M.system_config.data.boost_eq_left_dm2,  0,
    $audio_proc.hq_peq.zero_delay_data,      &$M.system_config.data.boost_eq_right_dm2, 0,
#endif

#if uses_USER_EQ
    $audio_proc.hq_peq.zero_delay_data,      &$M.system_config.data.user_eq_left_dm2,   0,
    $audio_proc.hq_peq.zero_delay_data,      &$M.system_config.data.user_eq_right_dm2,  0,
#endif
...
$App.Codec.Apply:
   ...
   // Set DSP volume
   M[$M.dac_out.audio_out_volume_left.param + $cbops.volume.FINAL_VALUE_FIELD]= r4;
   // Set DSP volume
   M[$M.dac_out.audio_out_volume_right.param + $cbops.volume.FINAL_VALUE_FIELD]= r4;
   // Set the auxillary mix operators hold timer
   M[$M.dac_out.auxillary_mix_left_op.param + $cbops.aux_audio_mix_op.TIMER_HOLD_FIELD] = r5;
   // Set the auxillary mix operators hold timer
   M[$M.dac_out.auxillary_mix_right_op.param + $cbops.aux_audio_mix_op.TIMER_HOLD_FIELD] = r5;
...
#if uses_VCAEC
   r6 = $M.A2DP_LOW_LATENCY_2MIC.SYSMODE.LOWVOLUME;
...
.MODULE $M.CVC.app.config;
   ...
   .VAR CVC_config_struct[$M.CVC.CONFIG.STRUC_SIZE] =
      ...
      $CVC_VERSION,                                // VERSION
      $M.A2DP_LOW_LATENCY_2MIC.SYSMODE.PSTHRGH_RIGHT,// BACK CHANNEL PASSTHROUGH
