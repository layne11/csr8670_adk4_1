...
// *****************************************************************************
// DESCRIPTION
//    This file defines the back end prcoessing for the CVC Handsfree
//    This include SCO/USB and WBS operations.   Wired mode replaces USB
//
// *****************************************************************************
...
.MODULE $far_end.out;
   .DATASEGMENT DM;
    ...
    DeclareCBuffer(frame_to_encoder.cbuffer_struc, frame_to_encoder.mem, 3*60);
    ...
    .BLOCK sw_copy_op;
        ...
        .VAR sw_copy_op.func = &$cbops.shift;
        .VAR sw_copy_op.param[$cbops.shift.STRUC_SIZE] =
