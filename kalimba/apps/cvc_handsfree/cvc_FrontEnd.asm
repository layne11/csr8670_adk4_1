...
// *****************************************************************************
// DESCRIPTION
//    This file defines the front end prcoessing for the CVC 1-MIC Handsfree
//
// External References:
//
//
...
//
   ...
   .VAR copy_struc[] =
      ...
      &rate_match_demux,              // MTU_FIRST_OPERATOR_FIELD
      1,                              // NUM_INPUTS_FIELD
...
$ConfigureFrontEnd:
    ...
    if NZ r1=r2;
    // for 1-mic ADC/DAC into frame process always the same sample rate
