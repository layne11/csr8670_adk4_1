.linefile 1 "cvc_handsfree_config.asm"
.linefile 1 "<command-line>"
.linefile 1 "cvc_handsfree_config.asm"
.linefile 20 "cvc_handsfree_config.asm"
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/stack.h" 1
.linefile 21 "cvc_handsfree_config.asm" 2
...
.linefile 22 "cvc_handsfree_config.asm" 2
...
.linefile 23 "cvc_handsfree_config.asm" 2
...
.linefile 24 "cvc_handsfree_config.asm" 2
...
.linefile 25 "cvc_handsfree_config.asm" 2
...
.linefile 26 "cvc_handsfree_config.asm" 2
...
.linefile 27 "cvc_handsfree_config.asm" 2
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/cbuffer.h" 1
.linefile 28 "cvc_handsfree_config.asm" 2
...
.linefile 29 "cvc_handsfree_config.asm" 2
...
.linefile 30 "cvc_handsfree_config.asm" 2


.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/operators\\iir_resamplev2\\iir_resamplev2_header.h" 1
.linefile 33 "cvc_handsfree_config.asm" 2



.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/fft_twiddle.h" 1
.linefile 10 "E:/ADK4.1/kalimba/lib_sets/sdk/include/fft_twiddle.h"
...
.linefile 3891 "E:/ADK4.1/kalimba/lib_sets/sdk/include/fft_twiddle.h"
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[128] =
            ...
            -0.9996988187,
            -0.0245412285;
.linefile 4489 "E:/ADK4.1/kalimba/lib_sets/sdk/include/fft_twiddle.h"
.ENDMODULE;
.linefile 37 "cvc_handsfree_config.asm" 2
.linefile 47 "cvc_handsfree_config.asm"
   .CONST $M.CVC.AEC.Num_FFT_Window $M.CVC.Num_FFT_Window * 2;
.linefile 78 "cvc_handsfree_config.asm"
.MODULE $M.CVC_MODULES_STAMP;
   ...
   .BLOCK ModulesStamp;
      ...
      .VAR s2 = 0xfeeb;
      .VAR s3 = 0xfeeb;
      .VAR CompConfig = 1*0x008000 + 1*0x004000 + 1*0x002000 + 1*0x001000 + 1*0x000800 + 1*0x000400 + 1*0x000002 + 1*0x000200 + 1*0x000100 + 1*0x000080 + 1*0x000040 + 1*0x000020 + 1*0x000010 + 1*0x000008 + 0*0x000004;
      .VAR s4 = 0xfeeb;
      .VAR s5 = 0xfeeb;
      .VAR s6 = 0xfeeb;
   .ENDBLOCK;
.ENDMODULE;
.linefile 100 "cvc_handsfree_config.asm"
...
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/cvc_handsfree_defaults_wb.dat" 1
...
0x00E6, 0x1479, 0x9999,
0x7999, 0x9900, 0x0001,
0x7333, 0x33FF, 0xFFD8,
0x0000, 0x0110, 0x09B9,
0x0000, 0x010C, 0xCCCC,
0x0280, 0x0000, 0x0001,
0xF800, 0x0004, 0x0000,
0x0400, 0x0020, 0x0000,
0x0000, 0x0000, 0x0002,
0xEC00, 0x0018, 0x0000,
0x0000, 0x017F, 0xFFFF,
0x0000, 0x0000, 0x0000,
0x0000, 0x0500, 0x0001,
...
0x7FFF, 0xFF23, 0xD70A,
0x0400, 0x0072, 0x1481,
0x4000, 0x0040, 0x0000,
0x0000, 0x0140, 0x0000,
0x0000, 0x0140, 0x0000,
0x0000, 0x0140, 0x0000,
0x0000, 0x0100, 0x0020,
0x0000, 0xCF00, 0x51D1,
...
0x0000, 0x1400, 0x51D1,
0x0051, 0xD11A, 0xBE60,
0x0000, 0x1A40, 0x0000,
0x0080, 0x00FD, 0x4000,
0x0050, 0x0000, 0x003C,
0x0200, 0x0006, 0x6A4A,
0x093F, 0xB304, 0xB60B,
0x007A, 0xA600, 0x7AA6,
0x0B3F, 0x305A, 0x9DF6,
0x4000, 0x0065, 0xAC8B,
0x1800, 0x0034, 0xCE07,
0xDA9D, 0xF800, 0xA1E8,
0x003D, 0x617F, 0xC29F,
0x003D, 0x617F, 0xC29F,
0x0352, 0x6902, 0x534A,
0x0253, 0x4A01, 0xA934,
0x00FF, 0x1F00, 0x0000,
0x06A4, 0xD404, 0xA694,
0x02A8, 0x55FA, 0xAF57,
0xFC03, 0x81FD, 0x57AC,
0x0000, 0x0000, 0x0001,
0x0000, 0x0108, 0x4E08,
0xFC03, 0x8103, 0xFC7F,
0x0000, 0x0100, 0x0002,
0x00AA, 0x1501, 0x8151,
0x0055, 0x0A03, 0x02A8,
0x0000, 0x0500, 0x0008,
0x0300, 0x0000, 0x0013,
0x043F, 0x7800, 0x0018,
0x0495, 0xC000, 0x000E,
0x0000, 0x2100, 0x0039,
0x003E, 0x8066, 0x6666,
0x0000, 0x017F, 0x9BCE,
0x6689, 0x6F00, 0x0019,
0x0000, 0x097F, 0xFFFF,
0x0000, 0x8100, 0x0006,
0x0000, 0x1100, 0x0008,
0x7FFF, 0xFF06, 0x6666,
0x2666, 0x6600, 0x0019,
0x0000, 0x097F, 0xFFFF,
0x0000, 0x8100, 0x0006,
0x0000, 0x1100, 0x0008,
0x7FFF, 0xFF06, 0x6666,
0x2666, 0x660B, 0x4CE0,
0x0400, 0x0005, 0xA670,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000
.linefile 130 "cvc_handsfree_config.asm" 2
   ;
   .VAR/DMCONST16 DefaultParameters_fe[] =
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/cvc_handsfree_defaults_fe.dat" 1
...
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000
.linefile 133 "cvc_handsfree_config.asm" 2
   ;
   .VAR/DMCONST16 DefaultParameters_nb[] =
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/cvc_handsfree_defaults_nb.dat" 1
...
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000
.linefile 136 "cvc_handsfree_config.asm" 2
   ;
   ...
   .VAR CurParams[2*ROUND(0.5*$M.CVC_HANDSFREE.PARAMETERS.STRUCT_SIZE)];
    ...
    .VAR/DM2 fft_circ[($M.filter_bank.Parameters.FFT256_BUFFLEN * 1)];
   ...
   .ENDBLOCK;
    ...
    .ENDBLOCK;
.linefile 246 "cvc_handsfree_config.asm"
   .VAR fft_obj[$M.filter_bank.fft.STRUC_SIZE] =
      0,
      &$M.dm1_scratch,
      &$M.dm1_scratch + ($M.filter_bank.Parameters.FFT256_BUFFLEN * 1),
      &fft_circ,
      BITREVERSE(&fft_circ),
   ...
   .VAR dcblock_parameters_wb[] =
        ...
        1;
.linefile 290 "cvc_handsfree_config.asm"
...
.CONST $RCV_HARMANCITY_HISTORY_EXTENSION $M.CVC.Num_Samples_Per_Frame;
   ...
   .VAR/DM2 rcv_peq_dm2[($audio_proc.peq.STRUC_SIZE + 2*(((5))+1) )] =
      ...
      &stream_map_rcvout,
      (5),
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RCV_PEQ_CONFIG,
      0 ...;
   ...
   .VAR/DM1 rcv_vad400[$M.vad400.OBJECT_SIZE_FIELD] =
      &vad_peq_output,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RCV_VAD_ATTACK_TC,
      0 ...;
   ...
   .VAR/DM rcv_agc400_dm[$M.agc400.STRUC_SIZE] =
      0,
      $M.CVC_HANDSFREE.CONFIG.RCVAGCBYP,
      $M.CVC_HANDSFREE.CONFIG.BYPASS_AGCPERSIST,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_RCV_AGC_G_INITIAL,
      &stream_map_rcvout,
      &stream_map_rcvout,
   ...
   .VAR/DM AEQ_DataObject[$M.AdapEq.STRUC_SIZE] =
      0,
      $M.CVC_HANDSFREE.CONFIG.AEQBYP,
      $M.CVC_HANDSFREE.CONFIG.BEXENA,
      ...
      1,
      2,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_AEQ_LO_GOAL_LOW,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_AEQ_HI_GOAL_LOW,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_BEX_TOTAL_ATT_LOW,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_BEX_HI2_GOAL_LOW,
      0,
      21771,
      14,
      33,
...
.linefile 579 "cvc_handsfree_config.asm"
   ...
   .VAR/DM2 SndSynthesisBank[$M.filter_bank.Parameters.ONE_CHNL_BLOCK_SIZE] =
      ...
      &stream_map_sndout,
      &bufd_outp,
      &fba_send + $M.filter_bank.Parameters.OFFSET_BEXP,
      &D_real,
      &D_imag,
      0 ...;
   ...
   .VAR oms270snd2_obj[$M.oms270.STRUC_SIZE] =
        ...
        &bufd_inp + $SND_HARMANCITY_HISTORY_OFFSET,
        &D_real,
        &D_imag,
        &fba_send + $M.filter_bank.Parameters.OFFSET_BEXP,
        &D_real,
   ...
   .VAR wnr_obj[$M.oms270.wnr.STRUC_SIZE] =
         ...
         &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_WNR_AGGR,
         &rcv_vad400 + $M.vad400.FLAG_FIELD,
   ...
   .VAR/DM1 adc_dc_block_dm1[($audio_proc.peq.STRUC_SIZE + 2*((1)+1) )] =
      &stream_map_sndin,
      &stream_map_sndin,
      1,
      &$M.CVC.data.dcblock_parameters_wb,
   ...
   .VAR/DM2 snd_peq_dm2[($audio_proc.peq.STRUC_SIZE + 2*(((5))+1) )] =
      ...
      &stream_map_sndout,
      (5),
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_SND_PEQ_CONFIG,
      0 ...;
   ...
   .VAR/DM1 snd_vad400[$M.vad400.OBJECT_SIZE_FIELD] =
      &vad_peq_output,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_SND_VAD_ATTACK_TC,
      0 ...;
   ...
   .VAR vad_hold[$M.CVC.vad_hold.STRUC_SIZE] =
      ...
      &rcv_vad400 + $M.vad400.FLAG_FIELD,
      0,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_SND_AGC_ECHO_HOLD_TIME,
      0 ...;
   ...
   .VAR/DM snd_agc400_dm[$M.agc400.STRUC_SIZE] =
      0,
      $M.CVC_HANDSFREE.CONFIG.SNDAGCBYP,
      0,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_SND_AGC_G_INITIAL,
      &stream_map_sndout,
      &stream_map_sndout,
   ...
   .VAR/DM1 ndvc_dm1[$M.NDVC_Alg1_0_0.BLOCK_SIZE + $M.NDVC_Alg1_0_0.MAX_STEPS] =
      0,
      $M.CVC_HANDSFREE.CONFIG.NDVCBYP,
      $M.NDVC_Alg1_0_0.MAX_STEPS,
      &snd2oms_LpXnz,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_NDVC_HYSTERESIS,
      0 ...;
   ...
   .VAR oms270snd1_obj[$M.oms270.STRUC_SIZE] =
        ...
        1.0,
        0, 0 ...;
.linefile 804 "cvc_handsfree_config.asm"
   ...
   .VAR/DM1CIRC ref_delay_buffer[($M.CVC.Num_Samples_Per_Frame * 4) + $aec510.fbc.wb.FILTER_SIZE];
   ...
   .VAR/DM1 fba_ref[$aec510.filter_bank.Parameters.ONE_CHNL_BLOCK_SIZE] =
      ...
      &X_imag,
      &ref_delay_stream,
      &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_REF_DELAY;

   .VAR FD_ref[] =
      &X_real,
      &X_imag,
      &fba_ref + $M.filter_bank.Parameters.OFFSET_BEXP;
  ...
  .VAR L_RatSqG[$aec510.RER_dim];
   ...
   .VAR aec_obj[$aec510.STRUCT_SIZE] =
         ...
         &$aec510.mode.wide_band,
         &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_CNG_Q,
         $M.CVC.AEC_RER_AGGR,
         &snd1oms_G,
         ...
         &oms270snd2_obj + $M.oms270.PTR_X_REAL_FIELD,
         &Ga_real,
         &Ga_imag,
         &BExp_Ga,
   ...
   .VAR vsm_fdnlp[$aec510.nlp.STRUCT_SIZE] =
         &aec_obj,
         &CurParams + $M.CVC_HANDSFREE.PARAMETERS.OFFSET_HD_THRESH_GAIN,
         &ZeroValue,
         &rcv_vad400 + $M.vad400.FLAG_FIELD,
         &AttenuationPersist,
         ...
         0 ...;
.linefile 1099 "cvc_handsfree_config.asm"
...
.linefile 1333 "cvc_handsfree_config.asm"
...
.linefile 1463 "cvc_handsfree_config.asm"
 ...
 .VAR/DM hfk_proc_funcsSnd[] =
      ...
      0;
.linefile 1586 "cvc_handsfree_config.asm"
   ...
   .VAR stream_map_refin[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      0 ...;
.linefile 1657 "cvc_handsfree_config.asm"
   .VAR stream_map_sndin[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_input_streams_ind,
      0 ...;
.linefile 1677 "cvc_handsfree_config.asm"
   .VAR stream_map_sndout[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      0 ...;
.linefile 1703 "cvc_handsfree_config.asm"
   .VAR stream_map_rcvin[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_input_streams_ind,
      0 ...;
.linefile 1723 "cvc_handsfree_config.asm"
   .VAR stream_map_rcvout[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_output_streams_ind,
      0 ...;
.linefile 1746 "cvc_handsfree_config.asm"
...
.ENDMODULE;
.linefile 1824 "cvc_handsfree_config.asm"
...
lp_param_copy:
   ...
   r1 = M[$M.hf.LoadPersistResp.persistent_agc_init];
...
func:
   ...
   rts;
.ENDMODULE;
.linefile 1964 "cvc_handsfree_config.asm"
...
setgains:
   ...
   rts;
.ENDMODULE;
.linefile 2029 "cvc_handsfree_config.asm"
...
$cvc.rcv_peq.process:
   ...
   jump $audio_proc.peq.process;
.ENDMODULE;
.linefile 2052 "cvc_handsfree_config.asm"
...
.CONST $CVC_HF_PERSIST_MGDC_OFFSET 0;
...
.CONST $CVC_HF_PERSIST_NUM_ELEMENTS 11;
...
func:
   ...
   rts;
.ENDMODULE;
.linefile 2172 "cvc_handsfree_config.asm"
.MODULE $M.pblock_send_handler;
   .CODESEGMENT PM;
   .DATASEGMENT DM;

   .CONST $CVC_HF_PERSIST_STORE_MSG_SIZE ($CVC_HF_PERSIST_NUM_ELEMENTS + 1);
   ...
   .VAR persist_data_hf[$CVC_HF_PERSIST_STORE_MSG_SIZE];
...
persist_store:
   ...
   M[$M.hf.LoadPersistResp.persistent_agc_init]=r0;
   r0 = r0 ASHIFT -8;
...
.ENDMODULE;
.linefile 2309 "cvc_handsfree_config.asm"
...
.ENDMODULE;
.linefile 2354 "cvc_handsfree_config.asm"
...
.ENDMODULE;
.linefile 2438 "cvc_handsfree_config.asm"
...
.ENDMODULE;
.linefile 2473 "cvc_handsfree_config.asm"
...
.ENDMODULE;
.linefile 2509 "cvc_handsfree_config.asm"
