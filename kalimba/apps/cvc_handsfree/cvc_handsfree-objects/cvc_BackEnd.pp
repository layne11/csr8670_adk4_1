.linefile 1 "cvc_BackEnd.asm"
.linefile 1 "<command-line>"
.linefile 1 "cvc_BackEnd.asm"
.linefile 13 "cvc_BackEnd.asm"
...
.CONST $WIRED_IN_PORT (($cbuffer.READ_PORT_MASK + 1) | $cbuffer.FORCE_PCM_AUDIO);
.CONST $WIRED_OUT_PORT (($cbuffer.WRITE_PORT_MASK + $PRIMARY_LEFT_OUT_PORT_NUMBER) | $cbuffer.FORCE_PCM_AUDIO);
.linefile 99 "cvc_BackEnd.asm"
.MODULE $far_end.out;
   .DATASEGMENT DM;

   .VAR/DMCIRC frame_to_encoder.mem[3*90]; .VAR frame_to_encoder.cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(frame_to_encoder.mem), &frame_to_encoder.mem, &frame_to_encoder.mem;

   .VAR/DMCIRC mem[$BLOCK_SIZE_SCO * 3]; .VAR cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(mem), &mem, &mem;
  ...
  .VAR/DM1CIRC sr_hist[$cbops.rate_adjustment_and_shift.SRA_COEFFS_SIZE];
    ...
    .BLOCK sw_copy_op;
        ...
        .VAR sw_copy_op.param[$cbops.rate_adjustment_and_shift.STRUC_SIZE] =
            ...
            &sr_hist,
            &sr_hist,
            &$far_end.in.sw_rate_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD,
            0,
            0 ...;
    .ENDBLOCK;
...
.MODULE $far_end.in;
    ...
    .VAR/DMCIRC mem_output[3*90]; .VAR output.cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(mem_output), &mem_output, &mem_output;
    .VAR/DMCIRC mem_input[3*93]; .VAR input.cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(mem_input), &mem_input, &mem_input;
...
.MODULE $sco_data;
   ...
   .VAR/DM buffer_ola[$plc100.OLA_LEN];
    ...
    .VAR/DM plc_obj[$plc100.STRUC_SIZE] =
                   ...
                   0,
                   $plc100.INITIAL_ATTENUATION,
                   0,
                   0 ...;


    .VAR/DM object[$sco_pkt_handler.STRUC_SIZE ] =
                   $SCO_IN_PORT | $cbuffer.FORCE_LITTLE_ENDIAN,
                   0,
                   &$far_end.in.input.cbuffer_struc,
                   &$far_end.in.output.cbuffer_struc,
                   0x2000,
                   0x0000,
                   0,
                   ...
                   0,
                   0,
                   &$far_end.out.cbuffer_struc,
                   30,
                   0,
                   0,
                   0,
                   0,
                   &$far_end.out.frame_to_encoder.cbuffer_struc,
                   120,
                   30,
...
.MODULE $M.BackEnd;
    ...
    .VAR sco_streaming = $FAR_END.AUDIO.SCO_SBC-$FAR_END.AUDIO.USB_PCM;
    .VAR wbs_sco_encode_func = 0;
    .VAR wbs_init_func = 0;
.linefile 308 "cvc_BackEnd.asm"
$ConfigureBackEnd:
    push rLink;
    ...
    r2 = $NUM_SAMPLES_4MS_16K;
    NULL = M[sco_streaming];
    if NZ r2 = Null;
    M[$M.CVC.data.stream_map_rcvin + $framesync_ind.JITTER_FIELD] = r2;

    M[$M.CVC.data.stream_map_rcvin + $framesync_ind.COUNTER_FIELD] = NULL;
