...
.linefile 16 "cvc_FrontEnd.asm" 2
...
.MODULE $cbops.scratch;
   .DATASEGMENT DM;
    ...
    .VAR/DMCIRC mem1[240]; .VAR cbuffer_struc1[$cbuffer.STRUC_SIZE] = LENGTH(mem1), &mem1, &mem1;

    .VAR/DMCIRC mem2[240]; .VAR cbuffer_struc2[$cbuffer.STRUC_SIZE] = LENGTH(mem2), &mem2, &mem2;
    .VAR/DMCIRC mem3[240]; .VAR cbuffer_struc3[$cbuffer.STRUC_SIZE] = LENGTH(mem3), &mem3, &mem3;
...
.MODULE $adc_in;
   ...
   .VAR copy_struc[] =
    ...
    .BLOCK rate_match_mux;
        ...
        .VAR rate_match_mux.main_next = 0;
    ...
    .BLOCK rate_match_demux;
        .VAR rate_match_demux.mtu_next = 0;
        .VAR rate_match_demux.main_next = $cbops.NO_MORE_OPERATORS;
...
.ENDMODULE;
.linefile 192 "cvc_FrontEnd.asm"
.MODULE $dac_out;
   .DATASEGMENT DM;
.linefile 207 "cvc_FrontEnd.asm"
    ...
    .BLOCK reference_copy_op;
        ...
        .VAR reference_copy_op.main_next = &resample_op;
    ...
    .BLOCK resample_op;
        .VAR resample_op.mtu_next = &reference_copy_op;
    ...
    .BLOCK sw_rate_adjust_op;
        ...
        .VAR sw_rate_adjust_op.param[$cbops.rate_adjustment_and_shift.STRUC_SIZE] =
            ...
            &sr_hist,
            &sr_hist,
            &sw_rate_monitor_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD,
            0,
            0 ...;
    .ENDBLOCK;
    ...
    .BLOCK dual_mono_demux;
        .VAR dual_mono_demux.mtu_next = 0;
...
.linefile 550 "cvc_FrontEnd.asm"
    ...
    .VAR cvc_sndin_resampler_lookup[] =
        ...
        44100, $M.iir_resamplev2.Up_80_Down_441.filter, $M.iir_resamplev2.Up_160_Down_441_low_mips.filter,
