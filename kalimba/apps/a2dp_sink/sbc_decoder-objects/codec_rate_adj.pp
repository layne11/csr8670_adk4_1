.linefile 1 "codec_rate_adj.asm"
.linefile 1 "<command-line>"
.linefile 1 "codec_rate_adj.asm"
.linefile 16 "codec_rate_adj.asm"
...
.linefile 17 "codec_rate_adj.asm" 2
...
.linefile 18 "codec_rate_adj.asm" 2
...
.linefile 19 "codec_rate_adj.asm" 2
.linefile 31 "codec_rate_adj.asm"
...
.linefile 32 "codec_rate_adj.asm" 2
...
.linefile 33 "codec_rate_adj.asm" 2
...
.linefile 36 "codec_rate_adj.asm" 2
...
.linefile 37 "codec_rate_adj.asm" 2
...
.MODULE $codec_rate_adj;
   ...
   .VAR/DMCIRC $codec_rate_adj_out_left[CODEC_RATE_ADJUSTMENT_CBUFFER_SIZE]; .VAR $codec_rate_adj_out_left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($codec_rate_adj_out_left), &$codec_rate_adj_out_left, &$codec_rate_adj_out_left;
   .VAR/DMCIRC $codec_rate_adj_out_right[CODEC_RATE_ADJUSTMENT_CBUFFER_SIZE]; .VAR $codec_rate_adj_out_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($codec_rate_adj_out_right), &$codec_rate_adj_out_right, &$codec_rate_adj_out_right;
   ...
   .VAR stereo[$cbops.rate_adjustment_and_shift.Process.STRUC_SIZE] =
      ...
      $codec_rate_adj_out_left_cbuffer_struc,
      $codec_resamp_out_right_cbuffer_struc,
      $codec_rate_adj_out_right_cbuffer_struc,
      0,
      ...
      length(hist_left),
      0 ...;
.linefile 160 "codec_rate_adj.asm"
...
.linefile 242 "codec_rate_adj.asm"
...
.linefile 285 "codec_rate_adj.asm"
run_rate_adjustment:
   ...
   push rLink;
.linefile 308 "codec_rate_adj.asm"
   ...
   jump $pop_rLink_and_rts;
.linefile 339 "codec_rate_adj.asm"
   config_quality:
   ...
   rts;
.linefile 379 "codec_rate_adj.asm"
