.linefile 1 "latency_reporting.asm"
.linefile 1 "<command-line>"
.linefile 1 "latency_reporting.asm"
.linefile 10 "latency_reporting.asm"
...
.linefile 11 "latency_reporting.asm" 2
...
.linefile 12 "latency_reporting.asm" 2
...
.linefile 41 "latency_reporting.asm"
.MODULE $M.media_packet_boundary_detection;
   .CODESEGMENT MEDIA_PACKET_BOUNDARY_DETECTION_PM;
   .DATASEGMENT DM;

   .VAR/DMCIRC $codec_packets_info[50]; .VAR $codec_packets_info_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($codec_packets_info), &$codec_packets_info, &$codec_packets_info;

   .VAR $codec_packets_info_last_write_address = &$codec_in;
   .VAR $codec_packets_info_last_timer_time = 0;
   .VAR $codec_packets_info_timer_gap = 5000;
...
.ENDMODULE;
.linefile 134 "latency_reporting.asm"
.MODULE $M.report_latency_to_vm;
   .CODESEGMENT REPORT_LATENCY_TO_VM_PM;
   .DATASEGMENT DM;
   .VAR smoothing_factor_low = 0.2;
   .VAR smoothing_factor_high = 0.6;
...
do_not_send_msg:
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 227 "latency_reporting.asm"
