...
.MODULE $M.music_example_message_payload_cache;
   .DATASEGMENT DM;
   .CONST $message.PAYLOAD_CACHE_SIZE 10;
...
func:
   ...
   M[$ancMode] = r1;
   if NZ r2 = r0;
   M[$M.MUSIC_EXAMPLE_MODULES_STAMP.CompConfig] = r2;
   rts;
.ENDMODULE;
.linefile 1343 "vm_message.asm"
...
func:
   ...
   r3 = r3 AND $MULTI_CHAN_AUX_CHANNELS_MASK;
   ...
   r0 = 1;
   r1 = -1;
   null = r3 AND (1 << $MULTI_CHAN_SUB_WIRED_OUT_CHAN);
   if Z r1 = r0;
...
func:
   ...
   r3 = M[$M.multi_chan_output.channels_mute_en];
   r3 = r3 AND $MULTI_CHAN_MAIN_CHANNELS_MASK;
...
func:
    ...
    r3 = $MULTI_CHAN_MAIN_CHANNELS_MASK | $MULTI_CHAN_AUX_CHANNELS_MASK;
    null = r1;
    if Z r3 = 0;
    push r2;
    call $multi_chan_soft_mute;
