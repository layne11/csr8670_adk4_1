.linefile 1 "codec_tones.asm"
.linefile 1 "<command-line>"
.linefile 1 "codec_tones.asm"
.linefile 18 "codec_tones.asm"
...
.linefile 22 "codec_tones.asm" 2

.MODULE $codec_tones;
   .DATASEGMENT DM;
   .CODESEGMENT PM;

   .VAR/DMCIRC $tone_in_left[256]; .VAR $tone_in_left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_left), &$tone_in_left, &$tone_in_left;
   .VAR/DMCIRC $tone_in_right[256]; .VAR $tone_in_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_right), &$tone_in_right, &$tone_in_right;
   .VAR/DMCIRC $tone_in_left_resample[(256 * 6)]; .VAR $tone_in_left_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_left_resample), &$tone_in_left_resample, &$tone_in_left_resample;
   .VAR/DMCIRC $tone_in_right_resample[(256 * 6)]; .VAR $tone_in_right_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_right_resample), &$tone_in_right_resample, &$tone_in_right_resample;


   .VAR $tone0_in_left_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_left_resample), &$tone_in_left_resample, &$tone_in_left_resample;
   .VAR $tone0_in_right_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_right_resample), &$tone_in_right_resample, &$tone_in_right_resample;
   .VAR $tone1_in_left_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_left_resample), &$tone_in_left_resample, &$tone_in_left_resample;
   .VAR $tone1_in_right_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_right_resample), &$tone_in_right_resample, &$tone_in_right_resample;
   .VAR $tone2_in_left_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_left_resample), &$tone_in_left_resample, &$tone_in_left_resample;
   .VAR $tone2_in_right_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_right_resample), &$tone_in_right_resample, &$tone_in_right_resample;
   ...
   .VAR $mono_tone_in_resample_copy_struc[] =
      $mono_tone_in_left_resample_op,
      1,
      $tone_in_left_cbuffer_struc,
      2,
      $tone_in_left_resample_cbuffer_struc,
      $tone_in_right_resample_cbuffer_struc;


   .VAR/DM1CIRC tone_left_resample_hist[$cbops.fir_resample.HIST_LENGTH]; .VAR/DM1CIRC tone_right_resample_hist[$cbops.fir_resample.HIST_LENGTH];
