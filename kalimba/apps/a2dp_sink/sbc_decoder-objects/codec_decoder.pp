...
.linefile 26 "codec_decoder.asm" 2
...
.linefile 49 "codec_decoder.asm" 2
.linefile 66 "codec_decoder.asm"
.MODULE $app_config;
   .DATASEGMENT DM;
...
.linefile 98 "codec_decoder.asm"
   ...
   .VAR $sbc_stats[$music_example.CODEC_STATS_SIZE] =
      ...
      &$M.system_config.data.ZeroValue,
      &$M.system_config.data.ZeroValue;
.linefile 296 "codec_decoder.asm"
...
.linefile 371 "codec_decoder.asm"
...
.linefile 485 "codec_decoder.asm"
...
.linefile 509 "codec_decoder.asm"
...
.linefile 614 "codec_decoder.asm"
...
.linefile 638 "codec_decoder.asm"
      call $sra_calcrate;
...
skip_a2dp_decode:
      ...
      call $sra_calcrate;
.linefile 677 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 766 "codec_decoder.asm"
...
.linefile 822 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 1032 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 1307 "codec_decoder.asm"
...
$set_dac_rate_from_vm:
   ...
   rts;
.ENDMODULE;
.linefile 1358 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 1400 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 1569 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 1626 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 1668 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 1730 "codec_decoder.asm"
.MODULE $M.conn_init;
...
.linefile 1793 "codec_decoder.asm"
      jump exit;
   ...
   i2s_conn_init:
      ...
      r0 = 48000*3;
      M[$sra_struct + $sra.AUDIO_AMOUNT_EXPECTED_FIELD] = r0;
.linefile 1866 "codec_decoder.asm"
      jump exit;
   ...
   skip_analogue_i2s_conn_init:
      ...
      skip_sbc:
.linefile 2052 "codec_decoder.asm"
         jump $error;
   exit:

   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 2246 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 2327 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 2360 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 2391 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 2434 "codec_decoder.asm"
...
.ENDMODULE;
.linefile 2499 "codec_decoder.asm"
.MODULE $M.set_input_handler_timer;
   ...
   r0 = M[r2+$INPUT_HANDLER_PERIOD_TABLE_LOW_RATE_INDEX];
   r1 = M[r2+$INPUT_HANDLER_PERIOD_TABLE_HIGH_RATE_INDEX];
