...
.linefile 1 "music_example_config.asm"
.linefile 16 "music_example_config.asm"
...
.linefile 17 "music_example_config.asm" 2
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/music_manager_config.h" 1
.linefile 18 "music_example_config.asm" 2
...
.linefile 20 "music_example_config.asm" 2
...
.linefile 21 "music_example_config.asm" 2
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/core_library.h" 1
.linefile 22 "music_example_config.asm" 2
...
.linefile 23 "music_example_config.asm" 2
...
.linefile 24 "music_example_config.asm" 2
.linefile 1 "user_eq.h" 1
.linefile 10 "user_eq.h"
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/cbuffer.h" 1
.linefile 11 "user_eq.h" 2
...
.linefile 25 "music_example_config.asm" 2
.linefile 1 "default_eq_coefs.h" 1
.linefile 24 "default_eq_coefs.h"
...
.linefile 26 "music_example_config.asm" 2
.linefile 38 "music_example_config.asm"
...
.linefile 39 "music_example_config.asm" 2
...
.linefile 40 "music_example_config.asm" 2
...
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/music_manager_defaults.dat" 1
...
0x0217, 0xF000, 0x0000,
0x0000, 0x0000, 0x000D,
0x0000, 0x6000, 0x0000,
0x0016, 0xA000, 0x000D,
0x0000, 0xC000, 0x0000,
0x0016, 0xA000, 0x000D,
0x0001, 0x7700, 0x0000,
0x0016, 0xA000, 0x000D,
0x0002, 0xEE00, 0x0000,
0x0016, 0xA000, 0x000D,
0x0005, 0xDC00, 0x0000,
0x0016, 0xA000, 0x000D,
0x000B, 0xB800, 0x0000,
0x0016, 0xA000, 0x000D,
0x0017, 0x7000, 0x0000,
0x0016, 0xA000, 0x000D,
0x002E, 0xE000, 0x0000,
0x0016, 0xA000, 0x000D,
0x005D, 0xC000, 0x0000,
0x0016, 0xA000, 0x000D,
0x00BB, 0x8000, 0x0000,
0x0016, 0xA000, 0x0001,
0x0000, 0x0000, 0x000A,
0x0004, 0xB000, 0x0000,
0x000B, 0x5000, 0x0000,
0x0000, 0x0000, 0x000D,
0x0001, 0x2C00, 0x0000,
0x000B, 0x5000, 0x000D,
0x0017, 0x7000, 0x0000,
0x000B, 0x5000, 0x000D,
0x000B, 0xB800, 0x0000,
0x000B, 0x5000, 0x000D,
0x0024, 0xEA00, 0x0000,
0x000B, 0x5000, 0x000D,
0x0075, 0x3000, 0x0000,
0x000B, 0x5000, 0x0006,
...
0x0000, 0x0000, 0x0B50,
0x0000, 0x0000, 0x0000,
0x0000, 0x0D00, 0x0060,
0x0000, 0x0000, 0x16A0,
0x0000, 0x0D00, 0x00C0,
0x0000, 0x0000, 0x16A0,
0x0000, 0x0D00, 0x0177,
0x0000, 0x0000, 0x16A0,
0x0000, 0x0000, 0x000F,
0x0000, 0x0FB1, 0xAA81,
0x571F, 0x3EC3, 0xECED,
0x4000, 0x0084, 0xDA2F,
0x3B31, 0x9440, 0x0000,
0xD53F, 0xA4FE, 0xA000,
0x4000, 0x0081, 0x543A,
0x3EB7, 0xE040, 0x0000,
0xBB3B, 0x4C24, 0xBC7F,
...
0x0001, 0x6800, 0x0000,
0x0009, 0xE300, 0x0008,
0x0001, 0x6800, 0x0000,
0x0008, 0x0000, 0x0008,
0x0001, 0x6800, 0x0000,
0x0019, 0xE300, 0x0008,
0x0001, 0x6800, 0x0000,
0x0009, 0xE300, 0x0008,
0x0001, 0x6800, 0x0000,
0x0019, 0xE300, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
...
0x0001, 0x6800, 0x0000,
0x0008, 0x4800, 0x0007,
0x0001, 0x6800, 0x0000,
0x000B, 0x5000, 0x0007,
0x0001, 0x6800, 0x0000,
0x001E, 0xE800, 0x0007,
0x0001, 0x6800, 0x0000,
0x0008, 0x4800, 0x0007,
0x0001, 0x6800, 0x0000,
0x000B, 0x5000, 0x0007,
0x0001, 0x6800, 0x0000,
0x001E, 0xE820, 0x0000,
0x0000, 0x0000, 0x0000,
...
0x0000, 0x0020, 0x0000,
0x1009, 0xB900, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0010, 0x09B9,
0x1009, 0xB920, 0x0000,
0x2000, 0x00F9, 0xB037,
0xFA05, 0x42FE, 0x56CC,
0xFF80, 0x7110, 0x0000,
0x0800, 0x0001, 0x5555,
0x00CC, 0xCC40, 0x28FD,
0x02EF, 0x1840, 0x28FD,
0x00E3, 0x2960, 0x28F0,
0x0097, 0x9D7C, 0x0CBE,
0x0071, 0xC708, 0x0000,
0xF9B0, 0x37FA, 0x0542,
0xFE56, 0xCCFF, 0x8071,
0x1000, 0x0008, 0x0000,
0x0155, 0x5500, 0xCCCC,
0x4028, 0xFD02, 0xEF18,
0x4028, 0xFD00, 0xE329,
0x6028, 0xF000, 0x979D,
0x7C0C, 0xBE00, 0x71C7,
0x0800, 0x0000, 0x0A5D,
0x0002, 0x5800, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0100, 0x0032,
0x0000, 0x0000, 0x0640,
0x0006, 0x4000, 0x0064,
0x000C, 0x8000, 0x0032,
0x0000, 0x0000, 0x0000,
0x0000, 0x000C, 0xCCCD,
0x0000, 0x3C00, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0000, 0x0000,
0x0000, 0x0002, 0x17F0,
0x0217, 0xF002, 0x17F0,
0x0217, 0xF002, 0x17F0,
0x0217, 0xF002, 0x17F0,
0x0217, 0xF002, 0x17F0,
0x0217, 0xF002, 0x17F0,
...
.linefile 246 "music_example_config.asm"
   ...
   .VAR passthru_primary_left[$M.audio_proc.stream_gain.STRUC_SIZE] =
     &stream_map_left_in,
     0,
     &ModeControl + $music_example.PRIM_LEFT_MANT,
     &ModeControl + $music_example.PRIM_LEFT_EXP;

   .VAR passthru_primary_right[$M.audio_proc.stream_gain.STRUC_SIZE] =
     &stream_map_right_in,
     0,
     &ModeControl + $music_example.PRIM_RGHT_MANT,
     &ModeControl + $music_example.PRIM_RGHT_EXP;

   .VAR passthru_sub[$M.audio_proc.stream_gain.STRUC_SIZE] =
     &stream_map_left_in,
     0,
     &ModeControl + $music_example.SUB_MANT,
     &ModeControl + $music_example.SUB_EXP;

   .VAR passthru_secondary_left[$M.audio_proc.stream_gain.STRUC_SIZE] =
     &stream_map_left_in,
     0,
     &ModeControl + $music_example.SCND_LEFT_MANT,
     &ModeControl + $music_example.SCND_LEFT_EXP;

   .VAR passthru_secondary_right[$M.audio_proc.stream_gain.STRUC_SIZE] =
     &stream_map_right_in,
     0,
     &ModeControl + $music_example.SCND_RGHT_MANT,
     &ModeControl + $music_example.SCND_RGHT_EXP;
   ...
   .VAR right_headroom_obj[$M.audio_proc.stream_gain.STRUC_SIZE] =
     ...
     &headroom_mant,
     &ZeroValue;
.linefile 301 "music_example_config.asm"
   ...
   .VAR/DM2 spkr_eq_right_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((10)))+2) )] =
    ...
    .VAR SpkrEqDefnTable[$user_eq.DEFINITION_TABLE_SIZE] =
        ...
        &SpkrEqCoefsA,
        &SpkrEqCoefsB;
.linefile 411 "music_example_config.asm"
   ...
   .VAR/DM2 boost_eq_right_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((1)))+2) )] =
    ...
    .VAR BoostEqDefnTable[$user_eq.DEFINITION_TABLE_SIZE] =
        ...
        &BoostEqCoefsA,
        &BoostEqCoefsB;
.linefile 465 "music_example_config.asm"
   ...
   .VAR/DM2 anc_eq_left_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((5)))+2) )] =
      &stream_map_left_in,
      &stream_map_left_in,
      (5),
      &AncEqCoefsA,
      0 ...;
   .VAR/DM2 anc_eq_right_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((5)))+2) )] =
      &stream_map_right_in,
      &stream_map_right_in,
      (5),
      &AncEqCoefsA,
    ...
    .VAR AncEqDefnTable[$user_eq.DEFINITION_TABLE_SIZE] =
        ...
        &AncEqCoefsA,
        &AncEqCoefsB;
.linefile 521 "music_example_config.asm"
   ...
   .VAR/DM2 user_eq_left_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((5)))+2) )] =
    ...
    .VAR/DM2 user_eq_right_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((5)))+2) )] =
      ...
      &UserEqCoefsA,
      0 ...;
.linefile 709 "music_example_config.asm"
        .VAR UserEqCoefsA[33] =
            0x000000,
            0x000001,
            0x400000,
...
.linefile 758 "music_example_config.asm"
    ...
    .VAR spkr_ctrl_init_struct[$spkr_ctrl_system.INIT_STRUCT_SIZE] =
        &spkr_ctrl_struct,
        &spkr_ctrl_pri_eq_defn_table,
        &spkr_ctrl_pri_eq_bank_select,
        0,
        0,
        &spkr_ctrl_bass_eq_defn_table,
        &spkr_ctrl_bass_eq_bank_select;
    ...
    .VAR spkr_ctrl_coefs[$spkr_ctrl_system.COEF_STRUCT_SIZE] =
        ...
        &spkr_ctrl_gain_coefs_A,
        &spkr_ctrl_gain_coefs_A,
        &spkr_ctrl_gain_coefs_B;

    .VAR spkr_ctrl_gain_coefs_A[$spkr_ctrl_system.COEF_GAIN.STRUCT_SIZE] =
        0x200000, 0x000000, 0x000000,
        0x000000, 0x200000, 0x000000,
    ...
    .VAR spkr_ctrl_gain_coefs_B[$spkr_ctrl_system.COEF_GAIN.STRUCT_SIZE] =
        ...
        0x100000, 0x100000, 0x000000,
        0x200000;



    .VAR/DM2 spkr_ctrl_left_pri_eq_dm[($audio_proc.peq.STRUC_SIZE + ((3*((7)))+2) )] =
        &stream_map_primary_left_out,
        &stream_map_primary_left_out,
        (7),
    ...
    .VAR/DM2 spkr_ctrl_right_pri_eq_dm[($audio_proc.peq.STRUC_SIZE + ((3*((7)))+2) )] =
        &stream_map_primary_right_out,
        &stream_map_primary_right_out,
        (7),
        &spkr_ctrl_pri_eq_coefs_A,
    ...
    .VAR spkr_ctrl_pri_eq_coefs_A[3+6*(7)] =
        0x000000,
        0x000001,
        0x400000,
        0x000000, 0x000000, 0x400000, 0x000000, 0x000000,
    ...
    .VAR spkr_ctrl_pri_eq_coefs_B[3+6*(7)] =
        0x000000,
        0x000001,
        0x400000,
        0x000000, 0x000000, 0x400000, 0x000000, 0x000000,
    ...
    .VAR/DM2 spkr_ctrl_pri_eq_bank_select[1 + (2)] =
        0,
    ...
    .VAR/DM2 spkr_ctrl_left_sec_eq_dm[($audio_proc.peq.STRUC_SIZE + ((3*((7)))+2) )] =
        &stream_map_secondary_left_out,
        &stream_map_secondary_left_out,
        (7),
    ...
    .VAR/DM2 spkr_ctrl_right_sec_eq_dm[($audio_proc.peq.STRUC_SIZE + ((3*((7)))+2) )] =
        &stream_map_secondary_right_out,
        &stream_map_secondary_right_out,
        (7),
        &spkr_ctrl_sec_eq_coefs_A,
    ...
    .VAR spkr_ctrl_sec_eq_coefs_A[3+6*(7)] =
        0x000000,
        0x000001,
        0x400000,
        0x000000, 0x000000, 0x400000, 0x000000, 0x000000,
    ...
    .VAR spkr_ctrl_sec_eq_coefs_B[3+6*(7)] =
        0x000000,
        0x000001,
        0x400000,
        0x000000, 0x000000, 0x400000, 0x000000, 0x000000,
    ...
    .VAR/DM2 spkr_ctrl_sec_eq_bank_select[1 + (2)] =
        0,
    ...
    .VAR/DM2 spkr_ctrl_bass_eq_dm[($audio_proc.peq.STRUC_SIZE + ((3*((6)))+2) )] =
        &spkr_ctrl_bass_buffer,
        &spkr_ctrl_bass_buffer,
        (6),
    ...
    .VAR spkr_ctrl_bass_eq_coefs_A[3+6*(6)] =
        0x000000,
        0x000001,
        0x400000,
        0x000000, 0x000000, 0x400000, 0x000000, 0x000000,
    ...
    .VAR spkr_ctrl_bass_eq_coefs_B[3+6*(6)] =
        0x000000,
        0x000001,
        0x400000,
        0x000000, 0x000000, 0x400000, 0x000000, 0x000000,
    ...
    .VAR/DM2 spkr_ctrl_bass_eq_bank_select[1 + (2)] =
        0,
...
.ENDBLOCK;
    ...
    .VAR/DM2 sub_eq_dm2[($audio_proc.peq.STRUC_SIZE + 2*(((3))+1) )] =
        &stream_map_sub_out,
        &stream_map_sub_out,
        (3),
        &SubEqCoefsA,
    ...
    .VAR WiredSubEqDefnTable[$user_eq.DEFINITION_TABLE_SIZE] =
        ...
        &SubEqCoefsA,
        &SubEqCoefsB;
.linefile 1097 "music_example_config.asm"
    ...
    .VAR cmpd100_obj_wired_sub[$cmpd100.STRUC_SIZE] =
     64,
     $M.MUSIC_MANAGER.CONFIG.WIRED_SUBWOOFER_COMPANDER_BYPASS,
     &stream_map_sub_out,
     &stream_map_sub_out,
     &stream_map_sub_out,
     &stream_map_sub_out,
...
.BLOCK sub_volume_and_limit_block;
   ...
   .VAR/DMCIRC delay_buf_pri_left[(max($ESCO_SUB_ALIGNMENT_DELAY,$L2CAP_SUB_ALIGNMENT_DELAY) + 1)]; .VAR delay_buf_pri_left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(delay_buf_pri_left), &delay_buf_pri_left, &delay_buf_pri_left;
   .VAR/DMCIRC delay_buf_pri_right[(max($ESCO_SUB_ALIGNMENT_DELAY,$L2CAP_SUB_ALIGNMENT_DELAY) + 1)]; .VAR delay_buf_pri_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(delay_buf_pri_right), &delay_buf_pri_right, &delay_buf_pri_right;
.linefile 1259 "music_example_config.asm"
   .VAR/DMCIRC delay_buf_sec_left[(max($ESCO_SUB_ALIGNMENT_DELAY,$L2CAP_SUB_ALIGNMENT_DELAY) + 1)]; .VAR delay_buf_sec_left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(delay_buf_sec_left), &delay_buf_sec_left, &delay_buf_sec_left;
   .VAR/DMCIRC delay_buf_sec_right[(max($ESCO_SUB_ALIGNMENT_DELAY,$L2CAP_SUB_ALIGNMENT_DELAY) + 1)]; .VAR delay_buf_sec_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(delay_buf_sec_right), &delay_buf_sec_right, &delay_buf_sec_right;
   .VAR/DMCIRC delay_buf_aux_left[(max($ESCO_SUB_ALIGNMENT_DELAY,$L2CAP_SUB_ALIGNMENT_DELAY) + 1)]; .VAR delay_buf_aux_left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(delay_buf_aux_left), &delay_buf_aux_left, &delay_buf_aux_left;
   .VAR/DMCIRC delay_buf_aux_right[(max($ESCO_SUB_ALIGNMENT_DELAY,$L2CAP_SUB_ALIGNMENT_DELAY) + 1)]; .VAR delay_buf_aux_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(delay_buf_aux_right), &delay_buf_aux_right, &delay_buf_aux_right;
   ...
   .VAR StatisticsPtrs[$M.MUSIC_MANAGER.STATUS.BLOCK_SIZE] =
      ...
      &$music_example.DAC_IF_Connections,
      &$music_example.SPDIF_IF_Connections,
      &$music_example.I2S_IF_Connections,
      &$music_example.OTA_IF_Connections,
      ...
      0 ...;
.linefile 1397 "music_example_config.asm"
   .VAR stream_map_left_in[$framesync_ind.ENTRY_SIZE_FIELD] =
    ...
    .VAR stream_map_right_in[$framesync_ind.ENTRY_SIZE_FIELD] =
          ...
          $frame_sync.update_input_streams_ind,
          0 ...;
.linefile 1432 "music_example_config.asm"
    ...
    .VAR stream_map_sub_out[$framesync_ind.ENTRY_SIZE_FIELD] =
     ...
     .VAR rcv_process_streams[] =
        ...
        &stream_map_sub_out,
        0;
.linefile 1537 "music_example_config.asm"
...
.VAR delay_reinitialize_table[] =
   ...
   .VAR filter_reset_table[] =
    ...
    0;
.linefile 1636 "music_example_config.asm"
    .VAR mode_table[] =
        &copy_proc_funcs,
        &copy_proc_funcs,
        &full_proc_funcs,
        ...
        0;
.linefile 1667 "music_example_config.asm"
    .VAR copy_proc_funcs[] =
...
.ENDMODULE;
.linefile 1891 "music_example_config.asm"
...
.ENDMODULE;
.linefile 2020 "music_example_config.asm"
...
func:
   ...
   if Z r4=NULL;
   M[$DAC_conn_main] = r4;
.linefile 2205 "music_example_config.asm"
   r2 = $MULTI_CHAN_PRIMARY_CHANNELS_LEFT_MASK;
   Null = r0 and r2;
   if Z jump no_pri_left;
