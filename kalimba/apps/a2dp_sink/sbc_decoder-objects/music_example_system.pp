...
.linefile 1 "music_example_system.asm"
.linefile 13 "music_example_system.asm"
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/stack.h" 1
.linefile 14 "music_example_system.asm" 2
...
.linefile 15 "music_example_system.asm" 2
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/core_library.h" 1
.linefile 16 "music_example_system.asm" 2
...
.linefile 17 "music_example_system.asm" 2
...
.linefile 18 "music_example_system.asm" 2
.linefile 1 "E:/ADK4.1/kalimba/lib_sets/sdk/include/music_manager_config.h" 1
.linefile 19 "music_example_system.asm" 2
...
.linefile 41 "music_example_system.asm"
...
.linefile 125 "music_example_system.asm"
   jump $pop_rLink_and_rts;

.ENDMODULE;
.linefile 147 "music_example_system.asm"
...
lp_param_copy:
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 216 "music_example_system.asm"
.MODULE $music_example.anc_eq;
   .CODESEGMENT MUSIC_EXAMPLE_PEQ_PM;
.DATASEGMENT DM;

process:
.linefile 229 "music_example_system.asm"
    Null = M[$ancMode];
    if Z rts;
    jump $music_example.peq.process;
.ENDMODULE;
.linefile 251 "music_example_system.asm"
...
initialize:
.linefile 272 "music_example_system.asm"
    r0 = M[&$M.system_config.data.CurParams + $M.MUSIC_MANAGER.PARAMETERS.OFFSET_CONFIG];
    r5 = M[r8];
...
process:
.linefile 307 "music_example_system.asm"
    r0 = M[&$M.system_config.data.CurParams + $M.MUSIC_MANAGER.PARAMETERS.OFFSET_CONFIG];
...
.ENDMODULE;
.linefile 341 "music_example_system.asm"
...
process:
   ...
   rts;
.ENDMODULE;
.linefile 406 "music_example_system.asm"
...
$music_example.power_up_reset:
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 497 "music_example_system.asm"
...
.ENDMODULE;
.linefile 616 "music_example_system.asm"
.MODULE $M.MUSIC_EXAMPLE_VERSION_STAMP;
   ...
   .ENDBLOCK;
.ENDMODULE;
.linefile 649 "music_example_system.asm"
.MODULE $M.MUSIC_EXAMPLE_MODULES_STAMP;
   ...
   .BLOCK ModulesStamp;
      ...
      .VAR s2 = 0xfeeb;
      .VAR s3 = 0xfeeb;
      .VAR CompConfig = ( (0x040000 * 1) + (0x020000 * 1) + (0x010000 * 1) + (0x800000 * 1) + (0x008000 * 1) + (0x002000 * 1) + (0x004000 * 1) + (0x001000 * 1) + (0x000800 * 1) + (0x000200 * 1) + (0x000100 * 1) + (0x000040 * 1) + (0x000080 * 1) + (0x200000 * 0) + (0x100000 * 0) + (0x080000 * 0) );
      .VAR s4 = 0xfeeb;
      .VAR s5 = 0xfeeb;
      .VAR s6 = 0xfeeb;
   .ENDBLOCK;
...
.MODULE $music_example;
 .DATASEGMENT DM;
   ...
   .VAR config_raw = ( (0x040000 * 1) + (0x020000 * 1) + (0x010000 * 1) + (0x800000 * 1) + (0x008000 * 1) + (0x002000 * 1) + (0x004000 * 1) + (0x001000 * 1) + (0x000800 * 1) + (0x000200 * 1) + (0x000100 * 1) + (0x000040 * 1) + (0x000080 * 1) + (0x200000 * 0) + (0x100000 * 0) + (0x080000 * 0) );
   .VAR config_anc = (( (0x040000 * 1) + (0x020000 * 1) + (0x010000 * 1) + (0x800000 * 1) + (0x008000 * 1) + (0x002000 * 1) + (0x004000 * 1) + (0x001000 * 1) + (0x000800 * 1) + (0x000200 * 1) + (0x000100 * 1) + (0x000040 * 1) + (0x000080 * 1) + (0x200000 * 0) + (0x100000 * 0) + (0x080000 * 0) ) + (0x000400 * 1));
...
.ENDBLOCK;
   ...
   .VAR Aux.MasterVolume = 0;
   .VAR Aux.ToneVolume = 0;
   .VAR Aux.LeftTrimVolume = 0;
   .VAR Aux.RightTrimVolume = 0;


   .VAR Main.MasterVolume = 0;
   .VAR Main.ToneVolume = 0;
   .VAR Main.PrimaryLeftTrimVolume = 0;
   .VAR Main.PrimaryRightTrimVolume = 0;
   .VAR Main.SecondaryLeftTrimVolume = 0;
   .VAR Main.SecondaryRightTrimVolume = 0;
   .VAR Main.SubTrimVolume = 0;
...
.BLOCK Statistics;
   ...
   .VAR SamplingRate = 0;
.linefile 733 "music_example_system.asm"
.ENDBLOCK;
