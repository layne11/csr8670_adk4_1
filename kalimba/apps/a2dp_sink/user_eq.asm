...
//------------------------------------------------------------------------------
   ...
   // switch coefficients
    ...
    if Z jump userEqInitialize.no2ndChannelEq;                  // if Z there isn't a right channel
        m[r7 + $audio_proc.peq.PARAM_PTR_FIELD] = r0;
        call $audio_proc.hq_peq.initialize;
...
//------------------------------------------------------------------------------
   ...
   // switch coefficients
    ...
    popm <r0,r7>;
    r7 = m[r7 + $user_eq.DEFINITION_TABLE_RIGHT_DM_PTR];        // r7 points to right channel EQ memory structure
    if Z jump eqInitialize.no2ndChannelEq;                      // if Z there isn't a right channel
        m[r7 + $audio_proc.peq.PARAM_PTR_FIELD] = r0;
        call $audio_proc.hq_peq.initialize;
...
//------------------------------------------------------------------------------
    ...
    popm <r0,r7>;
    r7 = m[r7 + $user_eq.DEFINITION_TABLE_RIGHT_DM_PTR];        // r7 points to right channel EQ memory structure
    if Z jump calcBankCoefs.no2ndChannelEq;                     // if Z there isn't a right channel
        m[r7 + $audio_proc.peq.PARAM_PTR_FIELD] = r0;
        call $audio_proc.hq_peq.initialize;
...
//------------------------------------------------------------------------------
    ...
    popm <r2,r7>;
    r7 = m[r7 + $user_eq.DEFINITION_TABLE_RIGHT_DM_PTR];        // r7 points to right channel EQ memory structure
    if Z jump calcBandCoefs.no2ndChannelEq;                     // if Z there isn't a right channel
        m[r7 + $audio_proc.peq.PARAM_PTR_FIELD] = r2;
        call $audio_proc.hq_peq.initialize;
