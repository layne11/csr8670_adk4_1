...
.CONST  $CVC_ONEMIC_HEADSET_SECID     0x258C;
   ...
   .VAR CVC_config_struct[$M.CVC.CONFIG.STRUC_SIZE] =
      ...
      $CVC_VERSION,                              // VERSION
      $M.A2DP_LOW_LATENCY_1MIC.SYSMODE.PASSTHRU, // STANDBY_MODE
...
#if uses_VCAEC
   r6 = $M.A2DP_LOW_LATENCY_1MIC.SYSMODE.LOWVOLUME;
...
.CONST $SND_HARMONICITY_HISTORY_EXTENSION  0;
   ...
   .VAR/ADDR_TABLE_DM   ParameterMap[] =
      ...
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_S_EQ_B1,  &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_S_EQ_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_S_EQ_B0,  &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_S_EQ_B0,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_S_EQ_A1,  &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_S_EQ_A1,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP1_B2, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP1_B2,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP1_B1, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP1_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP1_B0, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP1_B0,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP2_B2, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP2_B2,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP2_B1, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP2_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_L_AP2_B0, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_L_AP2_B0,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP1_B2, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP1_B2,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP1_B1, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP1_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP1_B0, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP1_B0,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP2_B2, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP2_B2,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP2_B1, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP2_B1,
      &CurParams + $M.A2DP_LOW_LATENCY_1MIC.PARAMETERS.OFFSET_MELOD_EXPANSION_R_AP2_B0, &$M.system_config.data.MeloD_Expansion_coefficients + $MeloD_Expansion.COEF_R_AP2_B0,
#endif
