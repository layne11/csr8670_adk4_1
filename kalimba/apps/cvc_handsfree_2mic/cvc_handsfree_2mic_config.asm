...
// Viterbi decoder storage
  ...
  .VAR/DM1 AnalysisBank_ASR[$M.filter_bank.Parameters.ONE_CHNL_BLOCK_SIZE] =
   ...
   .VAR/DM1 adf_object[$M.adf_alg_1_0_0.STRUCT_SIZE] =
      ...
      &rcv_vad400 + $M.vad400.FLAG_FIELD,  // OFFSET_VAD_RCV_FIELD
...
//wq      $frame_sync.sidestone_filter_op.InitializeFilter,     &$adc_in.sidetone_copy_op.param,  0,
   ...
   .VAR/DM FilterResetTable[] =
      ...
      $audio_proc.peq.zero_delay_data,      &sco_dcblock_dm2,           0,
#endif
...
.CONST $CVC_2MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_USB              2;
.CONST $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_USB              3;
.CONST $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_USB              4;
.CONST $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_USB                    5;
.CONST $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_USB                    6;
.CONST $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_USB            7;
.CONST $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_USB            8;
.CONST $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_USB              9;
.CONST $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_USB              10;
...
func:
   ...
   // CURRENT_ALPHA_INDEX
   r0 = M[r3 + $CVC_2MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_USB];
   M[persistent_current_alpha_index_usb] = r0;

   // AVERAGE_IO_RATIO
   r0 = M[r3 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_USB];
   r1 = M[r3 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_USB];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   // WARP_VALUE
   r0 = M[r3 + $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_USB];
   r1 = M[r3 + $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_USB];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   // INVERSE_WARP_VALUE
   r0 = M[r3 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_USB];
   r1 = M[r3 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_USB];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   // SRA_CURRENT_RATE
   r0 = M[r3 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_USB];
   r1 = M[r3 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_USB];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
...
$pblock_send_handler:
   ...
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_USB] = r0;
   ...
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_USB] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_2mic  + 1 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_USB] = r1;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_USB] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_USB] = r1;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_USB] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_USB] = r1;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_USB] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_USB] = r1;
...
// need to be changed. Set G_oms to NULL pointer to bypass
   ...
   // If X0 is lost then dont call ADF process function
   Null = M[r8 + $M.adf_alg_1_0_0.OFFSET_MGDC_switch_output];
   if NZ jump no_adf;
