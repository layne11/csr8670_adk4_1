...
lp_param_copy:
   ...
   // Add any special initialization here
...
.CONST $CVC_1MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_USB              2;
.CONST $CVC_1MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_USB              3;
.CONST $CVC_1MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_USB              4;
.CONST $CVC_1MIC_PERSIST_WARP_VALUE_HI_OFFSET_USB                    5;
.CONST $CVC_1MIC_PERSIST_WARP_VALUE_LO_OFFSET_USB                    6;
.CONST $CVC_1MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_USB            7;
.CONST $CVC_1MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_USB            8;
.CONST $CVC_1MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_USB              9;
.CONST $CVC_1MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_USB              10;
...
func:
   ...
   // CURRENT_ALPHA_INDEX
   r0 = M[r3 + $CVC_1MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_USB];
   M[persistent_current_alpha_index_usb] = r0;

   // AVERAGE_IO_RATIO
   r0 = M[r3 + $CVC_1MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_USB];
   r1 = M[r3 + $CVC_1MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_USB];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   // WARP_VALUE
   r0 = M[r3 + $CVC_1MIC_PERSIST_WARP_VALUE_HI_OFFSET_USB];
   r1 = M[r3 + $CVC_1MIC_PERSIST_WARP_VALUE_LO_OFFSET_USB];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   // INVERSE_WARP_VALUE
   r0 = M[r3 + $CVC_1MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_USB];
   r1 = M[r3 + $CVC_1MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_USB];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   // SRA_CURRENT_RATE
   r0 = M[r3 + $CVC_1MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_USB];
   r1 = M[r3 + $CVC_1MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_USB];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
...
persist_store:
   ...
   M[&persist_data_1mic + 1 + $CVC_1MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_USB] = r0;
   ...
   M[&persist_data_1mic + 1 + $CVC_1MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_USB] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_1mic  + 1 + $CVC_1MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_USB] = r1;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_1mic + 1 + $CVC_1MIC_PERSIST_WARP_VALUE_HI_OFFSET_USB] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_1mic + 1 + $CVC_1MIC_PERSIST_WARP_VALUE_LO_OFFSET_USB] = r1;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_1mic + 1 + $CVC_1MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_USB] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_1mic + 1 + $CVC_1MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_USB] = r1;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_1mic + 1 + $CVC_1MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_USB] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_1mic + 1 + $CVC_1MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_USB] = r1;
