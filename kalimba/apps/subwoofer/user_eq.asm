...
//------------------------------------------------------------------------------
// on entry r7 = pointer to user eq data object
...
//------------------------------------------------------------------------------
    ...
    r0 = r0 and $M.SUBWOOFER.CONFIG.USER_EQ_SELECT;
...
//------------------------------------------------------------------------------
    ...
    r2 = m[r7 + $audio_proc.peq.PARAM_PTR_FIELD];
    ...
    // r7 points to user eq data object
...
//------------------------------------------------------------------------------
    ...
    r8 = r0 + ($M.system_config.data.CurParams + $M.SUBWOOFER.PARAMETERS.OFFSET_USER_EQ_NUM_BANKS);
