...
%   "Application".
%
%   See also kalprofiler, kalmodname, kalreadval, kalwriteval, kalsymfind,
%
...
% TODO: temporarily copy stuff to the wonderful old variable names, to make the crazy stuff below work.
L    = moduleCount;
name = moduleNames;
h    = moduleHits;
pc   = pcSamples;
