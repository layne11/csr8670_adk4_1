...
#define HCI_MAX_ULP_OCF                                   ((hci_op_code_t)0x0027)
...
#define HCI_EV_MASK_ULP_VALID_LO                 ((hci_event_mask_t)0x000001BF)
...
#define HCI_BT_MODE_PARK           ((hci_bt_mode_t)(HCI_BT_MODE_SNIFF + 1))
/*
 ...
 */
#define HCI_BT_MODE_MAX            ((hci_bt_mode_t)HCI_BT_MODE_PARK + 1)
...
#define HCI_ULP_SCAN_FP_ALLOW_MAX           HCI_ULP_SCAN_FP_ALLOW_WHITELIST
