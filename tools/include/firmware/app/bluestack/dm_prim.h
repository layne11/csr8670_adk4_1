...
typedef enum dm_prim_tag
{
    ...
    ENUM_DM_HCI_ULP_SET_RANDOM_ADDRESS_REQ,
...
#define BT_VERSION_MAX              BT_VERSION_4p2
 ...
 *  Note : LE Secure Connection aware applications shall always set both 
...
/* This enum name should be changed from DM_SM_PERMANENT_ADDRESS_T
   to DM_SM_RANDOM_ADDRESS_T*/
typedef enum
{
...
/*
 * This API generate a random address of type requested and then
   set this value to controller.
   In case static address is provided by application, it sets the same
   static random address to controller if valid. Otherwise generate a new
   one and sets to controller.
 */
typedef struct
{
    dm_prim_t type;                     /* DM_SM_SET_PRIVACY_REQ */
    DM_SM_PERMANENT_ADDRESS_T set_permanent_address_type;/* random address type */
    TYPED_BD_ADDR_T static_addrt; /* Static address from application */
    DM_SM_PRIVACY_T privacy;            /* This is not used any more.*/
} DM_SM_CONFIGURE_LOCAL_ADDRESS_REQ_T;

/*
 * This confirmation provides random address generated and set
   to controller.
 */
typedef struct
{
    ...
    uint8_t status;
    DM_SM_PERMANENT_ADDRESS_T permanent_address_type; /* Type of random addess set to controller */
    TYPED_BD_ADDR_T random_addrt; /* Random address set to controller */
    DM_SM_PRIVACY_T privacy;      /* This is not used any more. */
