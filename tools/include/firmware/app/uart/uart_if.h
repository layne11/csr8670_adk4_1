...
DESCRIPTION
        ...
        This file is seen by the stack, and VM applications, and contains
        things that are common between them.
*/
/*!
 @file uart_if.h
 @brief The global definitions needed for configuring the UART.
*/
