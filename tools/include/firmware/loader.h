...
/*!
   @brief This API will reboot the firmware in "loader" mode.
   This trap can be used to trigger a DFU process based
   on an external event, for example: " A combination 
...
/*!
  @brief Retrieves the loader version from loader image. 
  @return The value that identifies loader version, if loader image is 
  present. Otherwise Zero.
*/
uint16 LoaderGetVersion(void);
