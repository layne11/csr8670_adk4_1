...
class Stack(object):
    """This class provides functionality to decode and display the call stack"""
    ...
    def trace(self):
        ...
        if self._core.sym.modname(rLink-1) != self._core.sym.modname(pc) and self._core.sym.modname(rLink-1) != module_name:
