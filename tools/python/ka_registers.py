...
class KaReg:
    def __init__(self, core):
        ...
        self._core._add_cfunc(self._cfuncs, 'ka_get_register_width'    , c_uint           , [c_void_p, c_int])
        self._core._add_cfunc(self._cfuncs, 'ka_get_register_id'       , c_int            , [c_void_p, c_char_p])
        self._core._add_cfunc(self._cfuncs, 'ka_get_register_names'    , POINTER(c_char_p), [])
        self._core._add_cfunc(self._cfuncs, 'ka_read_register'         , POINTER(ka_err), [c_void_p, c_int, POINTER(c_uint)])
        self._core._add_cfunc(self._cfuncs, 'ka_write_register'        , POINTER(ka_err), [c_void_p, c_int, c_uint])
        self._core._add_cfunc(self._cfuncs, 'ka_read_register_set'     , POINTER(ka_err), [c_void_p, POINTER(c_int), POINTER(c_uint), c_int])
        self._core._add_cfunc(self._cfuncs, 'ka_write_register_set'    , POINTER(ka_err), [c_void_p, POINTER(c_int), POINTER(c_uint), c_int])
    ...
    def get_register_width(self, id):
        ...
        return self._cfuncs['ka_get_register_width'](self._core._get_ka(), id)
    ...
    def get_register_id(self, name):
        ...
        res = self._cfuncs['ka_get_register_id'](self._core._get_ka(), name.upper())
    ...
    def get_register_names(self):
        ...
        return list(itertools.takewhile(lambda name: name != "NumRegs", raw_names))
    ...
    def read_register(self, register):
        ...
        result = c_uint()
        err = self._cfuncs['ka_read_register'](self._core._get_ka(), register, result)
    ...
    def write_register(self, register, val):
        ...
        if isinstance(register, str):
            register = self.get_register_id(register)
        err = self._cfuncs['ka_write_register'](self._core._get_ka(), register, val)
        self._core._handle_error(err)
    ...
    def read_register_set(self, registers):
        ...
        reg_values = (c_uint * num_registers)()

        err = self._cfuncs['ka_read_register_set'](self._core._get_ka(), reg_ids_for_c, reg_values, num_registers)
        self._core._handle_error(err)
        return map(lambda x:x, reg_values)
