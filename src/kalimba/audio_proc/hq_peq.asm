...
//      r7        - PEQ data structure
   ...
   r6 = r1 - ($audio_proc.peq.HQ_PEQ_HEADROOM_SHIFTS);
...
hq_peq_block_loop:
        ...
        r1 = m[i5,+1];
        do hq_biquad_loop;
            rmac = 0,                   r3 = m[i5,-1],      r4 = m[i1,+1];
            rmac0 = r3;
            rmac = rmac + r2 * r4,      m[i5,-1] = r0,      r4 = m[i1,+1];
            rmac = rmac + r1 * r4,      m[i5,m3] = r1,      r4 = m[i1,m1];  // +3   +1
            rmac = rmac + r0 * r4,      r2 = m[i5,+1],      r4 = m[i1,+1];
            rmac = rmac - r2 * r4,      r1 = m[i5,-1],      r4 = m[i1,+1];
            rmac = rmac - r1 * r4,      r2 = m[i5,-1],      r4 = m[i2,+1];
            r3 = rmac0;
            rmac0 = null;
            r0 = rmac ashift r4;
            m[i5,m3] = r3;
        hq_biquad_loop:
        r3 = m[i5,-1];      // dummy read
        r3 = m[i5,-1];      // dummy read
        m[i5,+1] = r1;
        m[i5,+1] = r0;
        
        // Restore headroom
        r0 = r0 ASHIFT ($audio_proc.peq.HQ_PEQ_HEADROOM_SHIFTS);
        pop r4;
