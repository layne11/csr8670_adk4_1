...
$audio_proc.delay.process:
   ...
   r6 = M[r8 + $audio_proc.delay.DELAY_FIELD];
...
// Update output frame size from input
   ...
   Null = M[r8 + $audio_proc.delay.MODE];
...
mode_16bit:  
   ...
   r4 = M[r8 + $audio_proc.delay.write_bytepos];
...
done_setting_delay_read:
   ...
   do loop_delay_16bit;
      ...
      write_byte_pos_0:
         r1 = M[I1,0];         // read from delay line, do not incremnet write pointer
   ...
   M[r8 + $audio_proc.delay.write_bytepos] = r4;  
