...
//       offset 1 - Tesco (slots) - period between SCO instants
//       offset 2 - Wesco (slots) - size of retransmission window
...
//#define DEBUG_SCO_PARMS
   ...
   if NZ r2 = r7 - r2;
   r2 = r2 - M1;                     // back up one slot to account for possible rounding error in usec->slot 
