...
.MODULE $M.cbops.mono_downsample_int;
   .DATASEGMENT DM;

   // ** function vector **
   .VAR $cbops.mono_downsample_int[$cbops.function_vector.STRUC_SIZE] =
      $cbops.function_vector.NO_FUNCTION,         // reset function
      &$cbops.resample.downsample_amount_to_use,  // amount to use function
      &$cbops.mono_downsample_int.main;               // main function
...
// *****************************************************************************
// MODULE:
//    $cbops.mono_downsample_int.main
//
// DESCRIPTION:
...
.MODULE $M.cbops.mono_downsample_int.main;
   .CODESEGMENT CBOPS_MONO_DOWNSAMPLE_INT_MAIN_PM;
   .DATASEGMENT DM;
...
$cbops.mono_downsample_int.main:
   ...
   .VAR/DM1 $cbops.profile_mono_downsample_int[$profiler.STRUC_SIZE] = $profiler.UNINITIALISED, 0 ...;

   r0 = &$cbops.profile_mono_downsample_int;
   call $profiler.start;
#endif
   ...
   do loop;
      ...
      // increment  write result   read next input
      // counter
      r5 = r5 + M3, M[I0,M1] = r1, r1 = M[I4,M3];
