...
.MODULE $M.cbops.stereo_iir_downsample;
   .DATASEGMENT DM;

   .VAR dn_amount;
   // ** function vector **
   .VAR $cbops.stereo_iir_downsample[$cbops.function_vector.STRUC_SIZE] =
      $cbops.function_vector.NO_FUNCTION,           // reset function
      &$cbops.stereo_iir_downsample.amount_to_use,  // amount to use function
      &$cbops.stereo_iir_downsample.main;           // main function
.ENDMODULE;

// *****************************************************************************
// MODULE:
//    $cbops.stereo_iir_downsample.amount_to_use
//
// DESCRIPTION:
//    operator amount_to_use function for Stereo IIR downsampler
//
// INPUTS:
...
//
// *****************************************************************************
.MODULE $M.cbops.stereo_iir_downsample.amount_to_use;
   .CODESEGMENT CBOPS_STEREO_IIR_DOWNSAMPLE_AMOUNT_TO_USE_PM;
...
// *****************************************************************************
// MODULE:
//    $cbops.stereo_iir_downsample.main
//
// DESCRIPTION:
//    operator main function for Stereo IIR downsampler
//
// INPUTS:
//    - r6  = pointer to the list of input and output buffer pointers
//    - r7  = pointer to the list of buffer lengths
//    - r8  = pointer to operator structure
//    - r10 = the number of samples to process (Not Used)
//
// OUTPUTS:
//    - r8  = pointer to operator structure
//
...
//
// *****************************************************************************
.MODULE $M.cbops.stereo_iir_downsample.main;
   .CODESEGMENT CBOPS_STEREO_IIR_DOWNSAMPLE_MAIN_PM;
   .DATASEGMENT DM;
   ...
   M[save] = r8;
   M[amount_to_write] = r10;

   I2 = r8;
   M0 = 1;

   // Save Channel 2 buffer information
   r1 = M[I2,M0];                   // INPUT_2_START_INDEX_FIELD
   r2 = M[I2,M0];                   // OUTPUT_2_START_INDEX_FIELD
   ...
   L0 = r1,				  r0=M[I2,M0];				// FILTER_DEFINITION_PTR_FIELD 
   ...
   // for stereo set R10, I0/L0 I4/L4 & I2 for second channel
   r0 = M[save];
   I2 = r0 + $cbops.stereo.iir_resample.CH2_SAMPLE_COUNT_FIELD;
