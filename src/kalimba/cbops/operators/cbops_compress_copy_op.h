...
#ifndef CBOPS_COMPRESS_COPY_HEADER_INCLUDED
#define CBOPS_COMPRESS_COPY_HEADER_INCLUDED
   ...
   .CONST   $COMPRESS_RANGE    0.1087;      // 0.1087 = 1 - dB_to_linear(-1dB)


#endif // CBOPS_COMPRESS_COPY_HEADER_INCLUDED
