// *****************************************************************************
// Copyright (c) 2012 - 2016 Qualcomm Technologies International, Ltd.         http://www.csr.com
// Part of ADK 4.1
//
// *****************************************************************************
...
#define SPDIF_STREAM_DECODE_HEADER_INCLUDED
   ...
   .CONST $spdif.stream_decode.OUTPUT_INTERFACE_NEW_TYPE_FIELD                          20; // new output interface type
   .CONST $spdif.stream_decode.OUTPUT_INTERFACE_NEW_LEFT_PORT_FIELD                     21; // new output interface left port
   .CONST $spdif.stream_decode.OUTPUT_INTERFACE_NEW_RIGHT_PORT_FIELD                    22; // new output interface right
   .CONST $spdif.stream_decode.OUTPUT_INTERFACE_UPDATE_INTERFACE_FIELD                  23; // flag showing request for change of output interface
   .CONST $spdif.stream_decode.OUTPUT_INTERFACE_INIT_ACTIVE_FIELD                       24; // flag shows whether output ports already active
   .CONST $spdif.stream_decode.STRUC_SIZE                                               25;
