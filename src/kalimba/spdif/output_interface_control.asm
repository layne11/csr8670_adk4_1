...
.MODULE $M.spdif.output_interface_control.init;
   ...
   r3 = &$spdif.frame_copy.audio_configure_response_message_handler;
...
.MODULE $M.spdif.output_interface_control.event_process;
   ...
   // 48000 -> 48000
   // 44100 -> 44100
   // 32000 -> 48000  -- use more popular rate
   // 96000 -> 48000  -- downsample
   // 88200 -> 48000  -- downsample
   r3 = 48000;
   r2 = M[r7 + $spdif.frame_copy.SAMPLING_FREQ_FIELD];
   Null = r2 - 44100;
   if NZ r2 = r3;

   // force output rate if requested
...
fade_out_timer_handler:
   // fading finished, invoke response handler
   r8 = M[$spdif.stream_decode.stream_decode_struct];
   r1 = M[r8 + $spdif.stream_decode.OUTPUT_INTERFACE_LEFT_PORT_FIELD];
   r2 = 1;
   jump $spdif.frame_copy.response_message_handler;
