...
#include "core_library.h"
   ...
   .CONST        $codec.av_decode.DECODE_TO_STALL_THRESHOLD                   $codec.av_decode.TWS_CALLBACK_FIELD + 1;   // not used
    .CONST       $codec.av_decode.STALL_TO_DECODE_THRESHOLD                   $codec.av_decode.DECODE_TO_STALL_THRESHOLD + 1;   // not used
   .CONST        $codec.av_decode.STALL_BUFFER_LEVEL_FIELD                    $codec.av_decode.STALL_TO_DECODE_THRESHOLD + 1; //In fraction of codec buffer size
