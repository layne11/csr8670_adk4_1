...
.const biquad_coeficients.exit_b2           1;
.const biquad_coeficients.exit_b1           2;
.const biquad_coeficients.exit_b0           3;
.const biquad_coeficients.exit_a2           4;
.const biquad_coeficients.exit_a1           5;
.const biquad_coeficients.exit_scale        6;
.const biquad_coeficients.exit_stack_size   6;
