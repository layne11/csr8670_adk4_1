                                    ...
                                    GATT_HID_CLIENT_SET_REPORT_T *hid_report_data)
{
    ...
    /* Make internal message and Process the request */
    {
        MAKE_HID_CLIENT_MESSAGE_WITH_LEN_U16( HID_CLIENT_INTERNAL_MSG_SET_REPORT,hid_report_data->report_len);
                                    ...
                                    GATT_HID_CLIENT_WRITE_BOOT_REPORT_T *hid_boot_report)
{
    ...
    /* Make internal message and Process the request */
    {
        MAKE_HID_CLIENT_MESSAGE_WITH_LEN_U16( HID_CLIENT_INTERNAL_MSG_WRITE_BOOT_REPORT,
