...
static bool usbEnumerateHidConsumerTransportControl(void)
{
    ...
    (void) VmalMessageSinkTask(StreamUsbClassSink(device->usb_interface[usb_interface_hid_consumer_transport]), &device->usb_task[usb_task_hid_consumer]);
...
static bool usbEnumerateHidKeyboard(bool consumer_active)
{
    ...
    (void) VmalMessageSinkTask(StreamUsbClassSink(device->usb_interface[usb_interface_hid_keyboard]), &device->usb_task[usb_task_hid_keyboard]);
