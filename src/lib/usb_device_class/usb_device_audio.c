...
static bool usbEnumerateAudioMic(usb_device_class_descriptor descriptor)
{
    ...
    (void) VmalMessageSinkTask(StreamUsbClassSink(device->usb_interface[usb_interface_audio_streaming_mic]), &device->usb_task[usb_task_audio_streaming]);
...
static bool usbEnumerateAudioSpeaker(usb_device_class_descriptor descriptor)
{
    ...
    device->usb_task[usb_task_audio_streaming].handler = audioStreamingHandler;
    (void) VmalMessageSinkTask(StreamUsbClassSink(device->usb_interface[usb_interface_audio_streaming_speaker]), &device->usb_task[usb_task_audio_streaming]);
...
static bool usbEnumerateAudioControl(usb_device_class_descriptor descriptor)
{
    ...
    (void) VmalMessageSinkTask(StreamUsbClassSink(device->usb_interface[usb_interface_audio_control]), &device->usb_task[usb_task_audio_control]);
