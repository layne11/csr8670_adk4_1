...
typedef enum
{
    digital_input_16_bit,
    digital_input_24_bit,
    digital_input_32_bit
} digitalInputBitsPerSample_t;

typedef struct
{
    unsigned input_device_type:4;                           /* USB or Analogue */
    digitalInputBitsPerSample_t digital_input_bits_per_sample:2;
...
extern const A2dpEncoderPluginTaskdata csr_a2dp_aptxhd_encoder_plugin;
