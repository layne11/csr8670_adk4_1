...
#define avrcp_browsing_supported(avrcp)     ((avrcp->local_extensions & AVRCP_BROWSING_SUPPORTED) == AVRCP_BROWSING_SUPPORTED)

#define avrcp_ver_default(avrcp)      ((avrcp->local_extensions & AVRCP_VERSION_1_6) == AVRCP_VERSION_1_6)

#define avrcp_controller_cat_default(avrcp)     (avrcp->local_controller_features == AVRCP_CONTROLLER_CAT_DEFAULT)
...
#define avrcp_target_cat_default(avrcp)     (avrcp->local_target_features == AVRCP_TARGET_CAT_DEFAULT)
...
#define avrcp_get_pdl_version(avrcp)           (((avrcp->local_extensions & AVRCP_VERSION_1_6) == AVRCP_VERSION_1_6) ? AVRCP_PDL_VERSION_16 : \
                                                                          ((avrcp->local_extensions & AVRCP_VERSION_1_5) == AVRCP_VERSION_1_5) ? AVRCP_PDL_VERSION_15 : \
                                                                          ((avrcp->local_extensions & AVRCP_VERSION_1_4) == AVRCP_VERSION_1_4) ? AVRCP_PDL_VERSION_14 : \
                                                                          ((avrcp->local_extensions & AVRCP_VERSION_1_3) == AVRCP_VERSION_1_3) ? AVRCP_PDL_VERSION_13 : \
