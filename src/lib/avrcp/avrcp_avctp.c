                                         ...
                                         Source     data)   
{
    ...
    unsigned pkt_size = hdr_size+data_len+AVCTP_SINGLE_PKT_HEADER_SIZE;
                                ...
                                uint16          packet_size)
{
    ...
    case AVCTP0_PACKET_TYPE_START:
        ...
        avrcp->avctp_packets_remaining = ptr[AVCTP_NUM_PKT_OFFSET] - 1;
...
void avbpAvctpFrameHeader(AVBP *avbp, uint8 *ptr , bool response)
{
    ...
    ptr[AVCTP_HEADER_START_OFFSET] |= (uint8)(avbp->trans_id << AVCTP0_TRANSACTION_SHIFT);
