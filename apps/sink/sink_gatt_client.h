...
#define GATT_CLIENT theSink.rundata->ble.gatt[index].client
...
#define NUM_SERVICE_MAX_ONE_INSTANCE 7 /* bas, ancs, ias, dis, gatt, spc and hrs */
#define NUM_SERVICE_MAX_TWO_INSTANCE 1 /* hid we allow 2 instance */
...
#define MAX_GATT_CLIENT_SERVICES   ((MAX_ONE_INSTANCE * NUM_SERVICE_MAX_ONE_INSTANCE) \
                                                           + (MAX_TWO_INSTANCE * NUM_SERVICE_MAX_TWO_INSTANCE))
