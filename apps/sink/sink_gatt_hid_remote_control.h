...
/* Maximum number of central mode HID connections */
#ifdef GATT_HID_REMOTE_CONTROL
#define GATT_CLIENT_MAX_HID_CONN (uint16)(GATT_HID_RC_MAX_REMOTE_SUPORTED)
#else
#define GATT_CLIENT_MAX_HID_CONN (uint16)(0)
#endif
