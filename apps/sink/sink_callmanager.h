...
/****************************************************************************
NAME
    sinkCallManagerIsCallWithoutSco

DESCRIPTION
    if call state is not idle but there is no audio sink associated with the
    hfp link at the requested index return TRUE, otherwise return FALSE
*/
