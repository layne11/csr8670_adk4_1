        ...
        for (i = 0 ; string_to_send[i] != '\0' ;i++)
        {
            ...
            {               
                ...
                case battery_0_to_9_scaling_1 :
                {
                    ...
                    unsigned scale_factor = (string_to_send[i] - battery_0_to_5) + 1;
                    unsigned batt_lvl = theSink.battery_state * scale_factor;
                    ...
                    if (batt_lvl > 9) 
                    {
                        ...
                        /*convert to ascii*/
                    string_to_send[i] = (char)(batt_lvl + '0');
                }  
                break;
                ...
                case battery_0_to_9_scaling_2 :
                {
                    ...
                    uint8 batt_lvl = battery_scaling_2[theSink.battery_state] ;
                    /*convert to ascii*/
                    string_to_send[i] = (char)(batt_lvl + '0');
                }
                break;
