...
#else
#define a2dpGetPeerIndex(Index) (FALSE)
#endif
/*************************************************************************
NAME    
    a2dpIsIndexPeer
...
DESCRIPTION
    Returns the stream state of the sink at the requested priority index.
...
DESCRIPTION
    Returns the role type of the sink at the requested priority index.
